...
const ba =
    <div className="flex flex-col gap-4">
        <h2 className="text-3xl">Bachelor's Degree</h2>
...
const ms =
    <div className="flex flex-col gap-4">
        <h2 className="text-3xl">Master's Degree</h2>
...
const other =
    <div className="flex flex-col gap-4">
        <h2 className="text-3xl">Diploma</h2>
    ...
    return (
        <>
            <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-transparent w-full gap-4 mx-auto px-8">
                ...
                <Card outText="Master's Degree" inText={ms} logo={"/ubc-logo.png"} size={400}>
                    <CanvasRevealEffect
                        animationSpeed={5}
                ...
                <Card outText="Other degree" inText={other} logo={"/bs-logo.png"} size={200}>
                    <CanvasRevealEffect
                        animationSpeed={5}
    ...
    return (
        ...
        >
            ...
            <div className="relative z-20">
                <div className="text-center text-3xl group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full mx-auto flex flex-col items-center justify-center absolute inset-0 z-10 gap-12">
                    {outText}
